...
class FightingiceEnv_Data_Frameskip(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        if "port" in kwargs.keys():
            ...
            try:
                import port_for
                self.port = 11552 #port_for.select_random()  # select one random port for java env
            except:
                raise ImportError(
    ...
    def _start_gateway(self, p2="KeyBoard"):
...
if __name__ == "__main__":
    env = gym.make("FightingiceDataFrameskip-v0", java_env_path="C:/Users/JasminRose/Desktop/FTG4.30")
